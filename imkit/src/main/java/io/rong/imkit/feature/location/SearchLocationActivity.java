...
public class SearchLocationActivity extends Activity {
    ...
    private void initView() {
        ...
        mSearchEditText.setOnTouchListener(
                ...
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(
                        ...
                        SearchLocationInfo searchLocationInfo =
                                (SearchLocationInfo) searchListAdapter.getItem(position);
        ...
        mPressBackImageView.setOnClickListener(
                ...
                public void onScroll(
                    ...
                    if (firstVisibleItem != 0
                        ...
                        View lastVisibleItemView =
                                searchListView.getChildAt(searchListView.getChildCount() - 1);
                        if (lastVisibleItemView != null
                                && lastVisibleItemView.getBottom() == searchListView.getHeight()) {
                    ...
                    public void onPoiSearched(PoiResult poiResult, int i) {
                        if (poiResult != null && poiResult.getPois().size() > 0) {
                            ...
                            for (int j = 0; j < poiItemList.size(); j++) {
                                ...
                                searchLocationInfo =
                                        new SearchLocationInfo(
                                                poiItem.getTitle(), poiItem.getSnippet());
                                searchLocationInfo.setLongitude(
                                        poiItem.getLatLonPoint().getLongitude());
                                searchLocationInfo.setLatitude(
                            ...
                            if (filterString.equals("")) {
                                ...
                                searchNoResult.setText(
                                        getResources().getString(R.string.rc_search_no_result));
                            }
    ...
    private class SearchListAdapter extends BaseAdapter {
        ...
        public SearchListAdapter(
                Context context, List<SearchLocationInfo> searchList, String keyword) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            setLocationAddress(
                    searchViewHolder.tvAddress, searchLocationInfo.getAddress(), keyword);
            return convertView;
        }
    ...
    private void setLocationTitle(TextView titleView, String locationTitle, String keyword) {
        ...
        if (subPosition >= 0) {
            colorFilterStr.setSpan(
                    new ForegroundColorSpan(
                            getResources().getColor(R.color.rc_map_search_highlight_color)),
                    subPosition,
                    subPosition + keyword.length(),
