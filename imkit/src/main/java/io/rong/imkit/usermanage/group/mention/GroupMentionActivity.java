 ...
 * @since 5.12.2
 */
public class GroupMentionActivity extends BaseActivity {
    ...
    public static Intent newIntent(
        ...
        Intent intent = new Intent(context, GroupMentionActivity.class);
    ...
    protected Fragment createFragment() {
        ...
        return IMCenter.getKitFragmentFactory().newGroupMentionFragment(bundle);
    }
}
