...
public class ConversationProcessorFactory {
    ...
    private ConversationProcessorFactory() {
        ...
        mProcessorMap.put(
                ...
                new CustomServiceBusinessProcessor());
        PublicServiceBusinessProcessor publicServiceProcessor =
    ...
    public void setProcessor(
            Conversation.ConversationType type, IConversationBusinessProcessor processor) {
