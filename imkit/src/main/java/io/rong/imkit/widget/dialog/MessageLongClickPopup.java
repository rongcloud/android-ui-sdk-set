...
/** 消息长按操作弹窗，使用 PopupWindow 实现，支持图标显示 */
public class MessageLongClickPopup {
    ...
    private void initPopupWindow() {
        ...
        final View contentView = inflater.inflate(R.layout.rc_popup_message_long_click, null);

        RecyclerView recyclerView = contentView.findViewById(R.id.rc_recycler_message_long_click);
    ...
    private class OptionsAdapter extends RecyclerView.Adapter<OptionsAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view =
                    LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.rc_popup_message_long_click_item, parent, false);
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            if (item.iconResId != 0) {
                // 使用 ThemeManager 从属性获取实际的 drawable 资源 ID
                int actualIconResId = IMKitThemeManager.getAttrResId(mContext, item.iconResId);
