...
public class ContactMessageItemProvider extends BaseMessageItemProvider<ContactMessage> {
    ...
    protected ViewHolder onCreateMessageContentViewHolder(ViewGroup parent, int viewType) {
        View view =
                LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.rc_message_contact_card, parent, false);
    ...
    public Spannable getSummarySpannable(Context context, ContactMessage contactMessage) {
        if (contactMessage != null
                && !TextUtils.isEmpty(contactMessage.getSendUserId())
            ...
            if (contactMessage.getSendUserId().equals(RongIM.getInstance().getCurrentUserId())) {
                String str_RecommendClause =
                        context.getResources().getString(R.string.rc_recommend_clause_to_others);
                return new SpannableString(
                        String.format(str_RecommendClause, contactMessage.getName()));
            } else {
                String str_RecommendClause =
