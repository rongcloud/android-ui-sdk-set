...
public class DestructHQVoiceMessageItemProvider extends BaseMessageItemProvider<HQVoiceMessage> {
    ...
    @Override
    protected void bindMessageContentViewHolder(final ViewHolder holder,ViewHolder parentHolder, HQVoiceMessage message, final UiMessage uiMessage, int position, List<UiMessage> list, IViewProviderListener<UiMessage> listener) {
