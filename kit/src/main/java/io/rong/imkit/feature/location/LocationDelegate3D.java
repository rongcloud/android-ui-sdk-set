...
public class LocationDelegate3D {
    ...
    private static final String TAG = "LocationDelegate3D";
    ...
    private static class SingletonHolder {
        private static final LocationDelegate3D INSTANCE = new LocationDelegate3D();
    }

    private LocationDelegate3D() {
    }
    ...
    public void bindConversation(final Context context, Conversation.ConversationType conversationType, String targetId) {
