...
public class CombineLocationPlugin
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        io.rong.imlib.model.Message message =
                io.rong.imlib.model.Message.obtain(mTargetId, mConversationType, locationMessage);
    ...
    private void sendOrShareLocation(
        ...
        OptionsPopupDialog.newInstance(currentFragment.getActivity(), items)
