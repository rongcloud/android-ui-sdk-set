...
public class AMapRealTimeActivity2D extends RongBaseNoActionbarActivity
    ...
    public void updateUserInfo(UserInfo userInfo) {
        ...
        if (userTarget != null) {
            ...
            View iconView =
                    LayoutInflater.from(AMapRealTimeActivity2D.this)
    ...
    private UserTarget createUserTargetById(final String userId) {
        ...
        userTarget.targetView.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
        ...
        public boolean onResourceReady(
            ...
            mHandler.postDelayed(
                    new Runnable() {
                        @Override
                        public void run() {
                            userTarget.targetMarker.setIcon(
                                    BitmapDescriptorFactory.fromView(iconView));
                        }
                    },
                    500);
            return false;
