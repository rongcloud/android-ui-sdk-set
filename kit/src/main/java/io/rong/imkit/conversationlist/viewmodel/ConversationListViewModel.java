...
public class ConversationListViewModel extends AndroidViewModel implements RongUserInfoManager.UserDataObserver {
    ...
    private RongIMClient.ResultCallback<Message> mCancelSendMediaMessageListener = new RongIMClient.ResultCallback<Message>() {
    ...
    private void getDeletedMsgConversation(
            final Conversation.ConversationType type, final String targetId, final int[] deleteMsgId) {
        RongIMClient.getInstance()
                .getConversation(
                        type,
                        targetId,
    ...
    protected void onCleared() {
        ...
        IMCenter.getInstance().removeCancelSendMediaMessageListener(mCancelSendMediaMessageListener);
    }
