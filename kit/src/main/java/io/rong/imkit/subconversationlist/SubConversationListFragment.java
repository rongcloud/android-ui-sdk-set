...
public class SubConversationListFragment extends ConversationListFragment {
        ...
        if (getActivity() != null && getActivity().getIntent() != null) {
            mConversationType =
                    (Conversation.ConversationType)
                            getActivity()
                                    .getIntent()
                                    .getSerializableExtra(RouteUtils.CONVERSATION_TYPE);
        }
    ...
    protected void subscribeUi() {
        if (this.getActivity() != null) {
            SubConversationListVMFactory factory =
                    new SubConversationListVMFactory(
                    ...
                    .observe(
                            ...
                            new Observer<List<BaseUiConversation>>() {
                                ...
                                public void onChanged(
                                        List<BaseUiConversation> baseUiConversations) {
