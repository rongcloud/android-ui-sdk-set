...
/** /~chinese 处理单聊、群聊、讨论组逻辑的公共类 */

/** /~english Common classes that deal with single chat, group chat, and discussion group logic */
public abstract class BaseBusinessProcessor implements IConversationBusinessProcessor {
     ...
     * /~english
     *
     * @return The number of history entries pulled during initialization. Currently, only chatrooms
     *     shall be copied
     */
    ...
    /** /~chinese 检查已读状态，如果 sp 有内容，则发送 */

    /** /~english Check the read status and send if the sp has content */
    @Override
