...
public class HistoryState implements IMessageState {
    ...
    /** /~english Jump to the specified history message */
    @Override
                                    ...
                                    if (messages != null && messages.size() > 0) {
                                        ...
                                        if (messages.size() < DEFAULT_COUNT + 1) {
                                            ...
                                            viewModel.onLoadMoreMessage(
                                                    messages.subList(0, DEFAULT_COUNT));
                                        }
                                    } else {
                                        viewModel.setState(IMessageState.normalState);
                                    }
     ...
     * /~english
     *
     * @param viewModel Historical messages slide to the bottom without any processing and continue
     *     to load more
     */
    @Override
