...
public abstract class BaseNotificationMessageItemProvider<T extends MessageContent>
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView =
                LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.rc_notification_message_item, parent, false);
        ...
        if (uiMessage != null && uiMessage.getMessage() != null && listener != null) {
            ...
            if (holder instanceof MessageViewHolder) {
                bindMessageContentViewHolder(
                        ((MessageViewHolder) holder).getChildViewHolder(),
                        holder,
