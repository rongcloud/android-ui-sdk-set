...
public class IMCenter {
    ...
    private List<RongIMClient.ResultCallback<Message>> mCancelSendMediaMessageListeners = new CopyOnWriteArrayList<>();
     ...
     */
    public void cancelSendMediaMessage(final Message message, final RongIMClient.OperationCallback callback) {
        RongIMClient.getInstance().cancelSendMediaMessage(message, new RongIMClient.OperationCallback() {
            @Override
            public void onSuccess() {
                if (callback != null) {
                    callback.onSuccess();
                }
                for (RongIMClient.ResultCallback<Message> listener : mCancelSendMediaMessageListeners) {
            ...
            public void onError(RongIMClient.ErrorCode errorCode) {
                ...
                for (RongIMClient.ResultCallback listener : mCancelSendMediaMessageListeners) {
    ...
    public void removeCancelSendMediaMessageListener(RongIMClient.ResultCallback<Message> listener) {
